...
const milestones = [
  {
    year: "2023",
    title: "Inception",
    description: "Vexel Systems founded with a vision to simplify technology.",
  },
  {
    year: "2024",
    title: "First Major ERP",
    description: "Launched our flagship ERP solution for retail businesses.",
  },
  {
    year: "2025",
    title: "Global Expansion",
    description: "Expanded operations to serve international clients.",
  },
];
        ...
        <div className="max-w-[1920px] w-[90%] md:w-[80%] mx-auto text-center">
          <MotionWrapper type="scale">
            <h1 className="text-4xl md:text-6xl font-black mb-6 flex flex-col items-center gap-2">
              ...
              <span className="text-primary">Vexel Systems.</span>
            </h1>
            <p className="text-xl text-foreground/80 max-w-2xl mx-auto">
              At Vexel Systems, our strength lies in the people who build,
              innovate, and lead with purpose. We are a founder-driven startup
              focused on delivering simple, powerful, and reliable technology
              solutions.
            </p>
          </MotionWrapper>
        </div>
        ...
        <div className="max-w-[1920px] w-[90%] md:w-[80%] mx-auto grid gap-24">
          {teamMembers.map((member, idx) => (
            <MotionWrapper
              key={idx}
              delay={idx * 0.2}
              type={idx % 2 === 0 ? "slideLeft" : "slideRight"}
            >
              <div
                className={`flex flex-col md:flex-row gap-12 items-center ${idx % 2 !== 0 ? "md:flex-row-reverse" : ""} group`}
              >
                {/* Image Card */}
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-3">
                      {member.expertise.map((skill, i) => (
                        <span
                          key={i}
                          className="px-4 py-2 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-lg text-sm font-medium shadow-sm hover:border-primary/50 transition-colors cursor-default"
                        >
                          {skill}
                        </span>
                      ))}
                  ...
                  <div className="flex items-center gap-4 pt-4 border-t border-foreground/10">
                    {member.socials.linkedin && (
                      <Link
                        ...
                        className="p-3 bg-foreground/5 rounded-full hover:bg-[#0077b5] hover:text-white transition-all transform hover:-translate-y-1"
                      >
                        <Linkedin size={20} />
                      </Link>
                    )}
                    {member.socials.github && (
                      <Link
                        ...
                        className="p-3 bg-foreground/5 rounded-full hover:bg-[#333] hover:text-white transition-all transform hover:-translate-y-1"
                      >
                        <Github size={20} />
                      </Link>
                    )}
                    {member.socials.instagram && (
                      <Link
                        ...
                        className="p-3 bg-foreground/5 rounded-full hover:bg-linear-to-tr hover:from-[#f9ce34] hover:via-[#ee2a7b] hover:to-[#6228d7] hover:text-white transition-all transform hover:-translate-y-1"
                      >
                        <Instagram size={20} />
                      </Link>
                    )}
                    {member.socials.facebook && (
                      <Link
                        ...
                        className="p-3 bg-foreground/5 rounded-full hover:bg-[#1877F2] hover:text-white transition-all transform hover:-translate-y-1"
                      >
                        <Facebook size={20} />
                      </Link>
                    )}
                    <Link
                      ...
                      className="p-3 bg-foreground/5 rounded-full hover:bg-red-500 hover:text-white transition-all transform hover:-translate-y-1"
                    >
                      <Mail size={20} />
                    </Link>
                  </div>
            ...
            <MotionWrapper delay={0.2} className="h-full">
              <div>
                ...
                <div className="grid gap-6 mt-6">
                  {[
                    {
                      title: "We Build Useful Things",
                      desc: "We don't just build; we solve problems.",
                    },
                    {
                      title: "No Secrets",
                      desc: "Open communication is our foundation.",
                    },
                    {
                    ...
                    },
                    {
                      ...
                      desc: "We evolve as technology evolves.",
                    },
                  ].map((item, i) => (
                    <div
                      key={i}
                      className="flex items-start gap-4 p-6 bg-background rounded-xl shadow-sm border border-foreground/5 cursor-default hover:border-primary/30 transition-colors"
                    >
            ...
            <MotionWrapper delay={0.4} className="h-full">
              <div>
                    ...
                    <MotionWrapper key={i} delay={0.2 + i * 0.2} type="scale">
                      <div className="relative pl-8 group">
                        ...
                        <div className="bg-foreground/5 p-6 rounded-2xl border border-foreground/5 hover:border-primary/20 transition-all duration-300 hover:shadow-xl hover:shadow-primary/5">
                          <span className="text-sm font-extrabold text-primary mb-2 block uppercase tracking-tighter">
                            {milestone.year}
                          </span>
                          <h4 className="text-2xl font-black mb-2 text-foreground">
                            {milestone.title}
                          </h4>
                ...
                <div className="mt-12 p-8 bg-black text-white rounded-2xl relative overflow-hidden">
                  ...
                  <Link
                    href="/careers"
                    className="inline-flex items-center gap-2 bg-primary text-white px-6 py-3 rounded-lg font-bold hover:bg-white hover:text-black transition-colors relative z-10"
                  >
