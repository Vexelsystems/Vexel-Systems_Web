          ...
          {filteredEvents.map((event) => (
            <div key={event.id} className="group bg-card border border-primary/10 rounded-2xl overflow-hidden hover:shadow-xl transition-all hover:-translate-y-1">
              ...
              <div className="p-8">
                ...
                <div className="pt-6 border-t border-primary/10 flex justify-between items-center bg-gray-50/50 -m-8 mt-0 p-6 px-8">
                   <div className="flex -space-x-2">
                      {[1,2,3].map((i) => (
                         <div key={i} className="size-8 rounded-full border-2 border-white bg-gray-200 flex items-center justify-center text-[8px] font-bold text-gray-500">
                            U{i}
                         </div>
                      ))}
