...
export const metadata = generatePageMetadata({
  title: "Cookie Policy",
  description:
    "Understand how Vexel Systems uses cookies to improve your browsing experience. Our policy explains the types of cookies we use and how you can manage your preferences.",
  keywords: [
    "cookie policy Vexel Systems",
    "website cookies transparency",
    "user consent Sri Lanka",
