  ...
  const nextSteps = [
    {
      id: 1,
      title: "Form Received",
      description: "We've securely received your project details.",
    ...
    },
    {
      ...
      description: "Our architects analyze your requirements.",
    ...
    },
    {
      ...
      description: "We'll schedule a call to discuss the roadmap.",
    ...
    },
    {
      id: 4,
      title: "Free Trial",
      description: "Get hands-on with your own dedicated account.",
      ...
      if (storedData) {
        ...
        try {
          ...
          logoImg.onload = () => {
            ...
            doc.text("Technology Made Simple", pageWidth / 2, 50, {
              align: "center",
            });
            ...
            const splitDesc = doc.splitTextToSize(
              data.project_details || "No details provided.",
              pageWidth - 70,
            );
            ...
            doc.setTextColor(80, 80, 80);
            doc.text(
              "1. Our specialized team handles your request.",
              20,
              remainingY + 8,
            );
            doc.text(
              "2. We analyze the feasibility and budget match.",
              20,
              remainingY + 14,
            );
            doc.text(
              "3. You receive a call/email within 24 hours.",
              20,
              remainingY + 20,
            );
            ...
            doc.setTextColor(60, 60, 60);
            doc.text(
              `Phone: ${companyDetails.contact.phone}  |  Email: ${companyDetails.contact.email}`,
              pageWidth / 2,
              footerStart + 6,
              { align: "center" },
            );
            ...
            doc.textWithLink("Facebook", pageWidth / 2 - 35, socialY, {
              url: companyDetails.socialLinks.facebook,
            });
            doc.textWithLink("LinkedIn", pageWidth / 2 - 12, socialY, {
              url: companyDetails.socialLinks.linkedin,
            });
            doc.textWithLink("Twitter", pageWidth / 2 + 12, socialY, {
              url: companyDetails.socialLinks.twitter,
            });
            doc.textWithLink("Instagram", pageWidth / 2 + 32, socialY, {
              url: companyDetails.socialLinks.instagram,
            });

            // Website
            doc.setTextColor(150, 150, 150);
            doc.text(
              companyDetails.contact.website,
              pageWidth / 2,
              footerStart + 20,
              { align: "center" },
            );
      ...
      <div className="max-w-[960px] w-full flex flex-col items-center">
        ...
        <div className="flex flex-col items-center text-center space-y-4 mb-12">
          ...
          <p className="max-w-2xl text-base font-normal leading-relaxed text-foreground/60">
            We've received your request and are preparing a personalized
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {nextSteps.map((step) => (
              ...
              >
                ...
                <h4 className="font-bold text-sm uppercase tracking-wider mb-1 opacity-60">
                  Step {step.id}
                </h4>
        ...
        <div className="w-full flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
            ...
            <Link
              href="/blog"
              className="flex items-center p-6 bg-card border border-primary/10 rounded-xl hover:shadow-md transition-all group hover:-translate-y-1"
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-foreground/50">
                  Insights and tips on scaling your retail business.
                </p>
              </div>
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-foreground/50">
                  How 500+ businesses grow with Vexel POS.
                </p>
              </div>
              <ArrowRight className="text-primary opacity-0 group-hover:opacity-100 transition-opacity ml-2 w-5 h-5" />
            </Link>
        ...
        <div className="mt-16 flex flex-col items-center text-center">
          <Link
            href="/"
            className="bg-primary text-white px-10 py-4 rounded-xl font-bold text-base hover:opacity-90 transition-all shadow-lg shadow-primary/20 mb-8"
          >
            Back to Home
          </Link>
