        ...
        <div className="lg:col-span-8 flex flex-col gap-8">
          ...
          <form className="flex flex-col gap-10">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
                <div className="flex flex-col gap-4">
                  <label className="text-foreground text-sm font-bold">Estimated Budget</label>
                  <select className="w-full rounded-lg border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 text-sm focus:border-primary focus:ring-primary h-12 outline-none px-3">
                  ...
                  <p className="text-xs text-foreground/50">Prices are indicative and based on general project scale.</p>
                </div>
                <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-4">
                <label className="text-foreground text-sm font-bold">Project Details</label>
                <textarea className="w-full rounded-xl border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm focus:border-primary focus:ring-primary outline-none p-4" placeholder="Describe your project goals, features, and any specific requirements..." rows={4}></textarea>
              </div>
              <div className="flex flex-col gap-4">
        ...
        <aside className="lg:col-span-4 flex flex-col gap-6">
            ...
            <ul className="flex flex-col gap-5">
              <li className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-foreground/50">From startups to Fortune 500 companies.</p>
                </div>
              </li>
              <li className="flex gap-4">
                <div className="text-primary mt-1">
                ...
                <div>
                  ...
                  <p className="text-xs text-foreground/50">Full NDA protection for your ideas.</p>
                </div>
              </li>
              <li className="flex gap-4">
                <div className="text-primary mt-1">
                ...
                <div>
                  ...
                  <p className="text-xs text-foreground/50">Fixed development squads for every project.</p>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gray-100 dark:bg-gray-900 p-4 rounded-xl text-center">
              ...
              <p className="text-[10px] uppercase font-bold text-foreground/50">Success Rate</p>
            </div>
            <div className="bg-gray-100 dark:bg-gray-900 p-4 rounded-xl text-center">
              <p className="text-2xl font-black text-primary">15+</p>
              <p className="text-[10px] uppercase font-bold text-foreground/50">Countries Served</p>
            </div>
          </div>
