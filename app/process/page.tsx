      ...
      <main className="flex-1 pb-20">
        ...
        <section className="px-4 py-20 bg-white dark:bg-background">
          <div className="max-w-[1200px] mx-auto text-center">
            <h1 className="text-5xl md:text-7xl font-black mb-6 tracking-tight">Our Strategic Process</h1>
        ...
        <section className="px-4 py-20 bg-primary/5 mt-20">
          <div className="max-w-[1000px] mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-black mb-4">Tangible Outcomes</h2>
        ...
        <section className="px-4 py-20">
          <div className="max-w-[1200px] mx-auto bg-primary rounded-[40px] p-12 md:p-16 text-center text-white relative overflow-hidden shadow-2xl">
            ...
            <h2 className="text-4xl md:text-6xl font-black mb-8 relative z-10">Scale Your Business Today</h2>
