...
export default function Home() {
  return (
    <main className="flex-1">
      {/* Hero Section */}
      <section className="px-6 md:px-20 lg:px-40 py-12 md:py-20 lg:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="flex flex-col gap-8 order-2 lg:order-1">
            <div className="flex flex-col gap-4">
              ...
              <h1 className="text-foreground text-4xl md:text-5xl lg:text-6xl font-black leading-tight tracking-[-0.033em]">
                Technology Made Simple for Your Business
              </h1>
              <p className="text-foreground/60 text-lg md:text-xl font-normal leading-relaxed max-w-[540px]">
            ...
            <div className="flex flex-wrap gap-4">
              <button className="bg-primary hover:bg-primary/90 text-white px-8 py-4 rounded-lg text-base font-bold transition-all shadow-lg shadow-primary/25">
                Get Started
              </button>
            ...
            <div className="flex items-center gap-6 pt-4">
              <div className="flex -space-x-3">
                <div className="relative size-10 rounded-full border-2 border-white dark:border-black overflow-hidden">
          ...
          <div className="order-1 lg:order-2">
            <div className="relative w-full aspect-square md:aspect-video lg:aspect-square bg-linear-to-br from-primary/20 to-transparent rounded-3xl overflow-hidden shadow-2xl">
              <Image 
                ...
                unoptimized
              />
              <div className="absolute bottom-6 left-6 bg-white dark:bg-black p-4 rounded-xl shadow-xl flex items-center gap-4">
                <div className="bg-green-100 dark:bg-green-900/30 p-2 rounded-lg">
                  <CheckCircle className="text-green-600" size={24} />
                </div>
                <div>
                  <p className="text-xs text-foreground/60 font-bold uppercase tracking-tighter">Uptime Guarantee</p>
                  <p className="text-lg font-black text-foreground">99.9% Reliable</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="bg-white dark:bg-black py-20">
        <div className="px-6 md:px-20 lg:px-40">
          <div className="flex flex-col items-center text-center mb-16">
            <h2 className="text-foreground text-3xl md:text-4xl font-black mb-4 tracking-tight">Our Core Services</h2>
            <div className="w-16 h-1.5 bg-primary rounded-full"></div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Card 1 */}
            <div className="group flex flex-col gap-6 rounded-2xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50 p-8 hover:shadow-xl hover:-translate-y-1 transition-all">
              ...
              <div className="flex flex-col gap-3">
                <h3 className="text-foreground text-xl font-bold">Web Development</h3>
                <p className="text-foreground/60 text-base leading-relaxed">
                  Scalable and responsive web applications built with modern frameworks and cloud-native architecture.
                </p>
              </div>
              <a className="mt-auto text-primary font-bold text-sm flex items-center gap-2" href="#">
            ...
            <div className="group flex flex-col gap-6 rounded-2xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50 p-8 hover:shadow-xl hover:-translate-y-1 transition-all">
              ...
              <div className="flex flex-col gap-3">
                <h3 className="text-foreground text-xl font-bold">Mobile Development</h3>
                <p className="text-foreground/60 text-base leading-relaxed">
            ...
            <div className="group flex flex-col gap-6 rounded-2xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50 p-8 hover:shadow-xl hover:-translate-y-1 transition-all">
              ...
              <div className="flex flex-col gap-3">
                <h3 className="text-foreground text-xl font-bold">Custom Software</h3>
                <p className="text-foreground/60 text-base leading-relaxed">
      ...
      <section className="py-24 bg-white dark:bg-black overflow-hidden relative">
        ...
        <div className="px-6 md:px-20 lg:px-40 relative z-10">
