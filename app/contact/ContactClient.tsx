        ...
        <div className="w-[92%] md:w-[90%] mx-auto max-w-[1400px]">
          <MotionWrapper type="slideUp" duration={1.2}>
            ...
            <p className="text-foreground/60 text-lg max-w-2xl">
              Partner with {companyDetails.name} for global technology solutions
              and innovative software development. We're here to turn your
              vision into reality.
            </p>
          </MotionWrapper>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-foreground/60">
                    Schedule a dedicated strategy session with our leads.
                  </p>
                </div>
              </div>
              <Link
                href="/consultation"
                className="px-6 py-3 bg-primary text-white font-bold rounded-xl whitespace-nowrap text-sm"
              >
                Book Consultation
              </Link>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <section className="bg-white/40 dark:bg-white/5 backdrop-blur-md p-8 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 h-fit">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <button
                    className="flex-1 py-4 bg-primary text-white font-bold rounded-lg hover:bg-primary/90 transition-all flex items-center justify-center gap-2"
                    type="submit"
                  >
            ...
            <section className="flex flex-col justify-between py-4">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/60 leading-relaxed">
                      ...
                      {companyDetails.address.postalCode},<br />
              ...
              <div className="mt-12 lg:mt-0 pt-10 border-t border-gray-200 dark:border-gray-800">
                ...
                <div className="flex gap-4">
                  <a
                    className="w-10 h-10 rounded-full bg-gray-200 dark:bg-gray-800 flex items-center justify-center transition-all text-foreground/60"
          ...
          <section className="mt-20 lg:mt-32">
            ...
            <div className="mt-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div className="flex items-center gap-2 text-foreground/60 text-sm">
                <Clock size={16} />
                <span>
                  Opening Hours: {companyDetails.business.workingHours.days},{" "}
                  {companyDetails.business.workingHours.time} (
                  {companyDetails.business.workingHours.timezone.split(" ")[0]})
                </span>
              </div>
              <a
