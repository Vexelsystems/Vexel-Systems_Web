        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            <MotionWrapper type={isAI ? "scale" : "slideUp"} duration={1.2}>
              <div
                className={`inline-flex items-center gap-2 px-4 py-2 rounded-full ${themeBg} border border-white/10 mb-8`}
              >
                <div
                  className={`size-2 rounded-full animate-pulse ${themeColor.replace("text", "bg")}`}
                />
                <span
                  className={`text-[10px] font-black uppercase tracking-[0.3em] ${themeColor}`}
                >
                  Service Detail • {service.slug.replace(/-/g, " ")}
                </span>
              </div>
              ...
              <h1 className="text-4xl md:text-6xl lg:text-8xl font-black text-foreground leading-[0.9] tracking-tighter mb-8 italic">
                {service.title.split(" ").map((word, i) => (
                  <span
                    key={i}
                    className={
                      i === 0 ? "text-primary block not-italic uppercase" : ""
                    }
                  >
                    {word}{" "}
                  </span>
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="p-6 rounded-4xl bg-foreground/5 border border-foreground/5 flex flex-col gap-2 group hover:bg-primary transition-colors">
                    <span className="text-4xl font-black group-hover:text-primary-foreground group-hover:text-white">
                      100%
                    </span>
                    <span className="text-[10px] font-black uppercase tracking-widest opacity-40 group-hover:text-white/60">
                      Deployment Success
                    </span>
                  </div>
                  <div className="p-6 rounded-4xl bg-primary/5 border border-primary/5 flex flex-col gap-2 group hover:bg-foreground transition-colors">
                    <span className="text-4xl font-black text-primary group-hover:text-background">
                      24/7
                    </span>
                    <span className="text-[10px] font-black uppercase tracking-widest text-primary/60 group-hover:text-white/40">
                      Active Monitoring
                    </span>
                  </div>
                </div>
              ...
              <div className="relative">
                ...
                <div className="relative aspect-4/5 rounded-3xl overflow-hidden group">
                  ...
                  <div className="absolute bottom-10 left-10 p-8 rounded-3xl bg-white/10 backdrop-blur-xl border border-white/20">
                    <p className="text-white text-xs font-black uppercase tracking-[0.3em] mb-2">
                      Internal Codebase
                    </p>
                    <h4 className="text-white text-2xl font-black italic">
                      Vexel Engine v4.2
                    </h4>
                  </div>
                </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
            <div className="max-w-2xl">
              <h2 className="text-5xl md:text-7xl font-black tracking-tighter mb-6 italic">
                Core{" "}
                <span className="text-primary not-italic">Capabilities.</span>
              </h2>
              <p className="text-white/60 text-lg font-medium">
                Specialized solutions engineered to push the boundaries of
                what's possible in the {service.slug.replace(/-/g, " ")} space.
              </p>
            </div>
                  ...
                  <div className="p-10 rounded-[3rem] bg-white/5 border border-white/10 hover:border-primary/50 transition-all group h-full">
                    ...
                    <ul className="space-y-3">
                      {sub.features?.map((feat, fidx) => (
                        <li
                          key={fidx}
                          className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-white/30 group-hover:text-white/60 transition-colors"
                        >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-6xl font-black tracking-tighter mb-4 italic">
              The <span className="text-primary not-italic">Power</span> Stack
            </h2>
            <p className="text-foreground/40 text-lg font-bold uppercase tracking-[.2em]">
              Our Industry-Leading Technology Suite
            </p>
          </div>
            ...
            <div className="relative grid md:grid-cols-3 gap-px bg-white/5 p-px">
              {service.roadmap.map((item, idx) => (
                <MotionWrapper key={idx} type="slideUp" delay={idx * 0.1}>
                  <div
                    className={`p-12 h-full relative group hover:bg-white/5 transition-all ${item.status === "current" ? "bg-primary/10" : ""}`}
                  >
                    {item.status === "current" && (
                      <div className="absolute top-6 right-6 px-3 py-1 rounded-full bg-primary text-[8px] font-black text-white uppercase tracking-widest animate-pulse">
                        Running Now
                      </div>
                    )}
                    ...
                    <h4 className="text-white text-2xl font-black mb-6 italic tracking-tight uppercase">
                      {item.phase}
                    </h4>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="mb-20">
              <h2 className="text-5xl md:text-7xl font-black tracking-tighter italic">
                The <span className="text-primary not-italic">Blueprint.</span>
              </h2>
              <p className="text-foreground/40 mt-4 text-xl font-medium tracking-tight">
                Our rigid deployment sequence for guaranteed success.
              </p>
            </div>
              ...
              {service.process.map((step, idx) => (
                <MotionWrapper key={idx} type="fade" delay={idx * 0.1}>
                  <div className="group p-8 rounded-[2.5rem] bg-white/40 dark:bg-white/5 border border-black/5 dark:border-white/5 h-full relative overflow-hidden transition-all hover:translate-y-[-10px]">
                    ...
                    <span className="text-7xl font-black text-black/5 dark:text-white/5 absolute -right-4 -bottom-4 tracking-tighter leading-none">
                      {idx + 1}
                    </span>
                    <h4 className="text-xl font-black mb-4 relative z-10">
                      {step.title}
                    </h4>
                    <p className="text-xs font-semibold text-foreground/50 leading-relaxed relative z-10">
                      {step.description}
                    </p>
                  </div>
                </MotionWrapper>
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
              <div className="max-w-2xl">
                <h2 className="text-5xl md:text-7xl font-black tracking-tighter mb-6 italic">
                  Proven{" "}
                  <span className="text-primary not-italic">Impact.</span>
                </h2>
                <p className="text-white/40 text-lg font-medium">
                  Real-world results delivered to our enterprise partners.
                </p>
              </div>
              <div className="hidden md:block">
                    ...
                    <div className="aspect-video relative overflow-hidden">
                      ...
                      <div className="absolute bottom-8 left-8 right-8">
                        <div className="flex items-end justify-between gap-4">
                          <div>
                            <h4 className="text-3xl font-black text-white italic mb-2">
                              {study.title}
                            </h4>
                          ...
                          <div className="text-right">
                            <span className="text-5xl font-black text-primary leading-none tracking-tighter">
                              {study.stat}
                            </span>
                          </div>
                        </div>
            ...
            <div className="grid lg:grid-cols-3 gap-16 items-start">
              <div className="lg:col-span-1 border-l-4 border-primary pl-8">
                <h2 className="text-5xl font-black tracking-tighter italic leading-none mb-8 text-white">
                  The <span className="text-primary">Winning</span> Edge.
                </h2>
                <p className="text-white/40 font-medium">
                  Quantifiable advantages that separate our partners from their
                  competition.
                </p>
              </div>
                ...
                {service.benefits.map((benefit, idx) => (
                  <MotionWrapper key={idx} type="scale" delay={idx * 0.1}>
                    <div className="p-10 rounded-[3rem] bg-white/5 border border-white/10 h-full flex flex-col gap-4 group hover:bg-primary transition-colors text-white">
                      <h4 className="text-2xl font-black tracking-tighter text-white group-hover:text-primary transition-colors">
                        {benefit.title}
                      </h4>
                      <p className="text-sm font-medium text-white/50 leading-relaxed group-hover:text-white/80">
                        {benefit.description}
                      </p>
                    </div>
                  </MotionWrapper>
        ...
        <section className="py-24 px-6 bg-zinc-50 dark:bg-zinc-900/30">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-black uppercase tracking-widest italic">
                Vexel vs <span className="text-primary not-italic">Others</span>
              </h2>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-20">
              <h2 className="text-5xl md:text-7xl font-black tracking-tighter mb-6 text-white">
                Investment <span className="text-primary italic">Tiers</span>
              </h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {service.pricing.options.map((option, idx) => (
                <MotionWrapper key={idx} type="slideUp" delay={idx * 0.1}>
                  <div
                    className={`p-12 rounded-[3.5rem] border h-full flex flex-col relative transition-all duration-500 hover:translate-y-[-10px] ${idx === 1 ? "bg-primary text-white border-primary shadow-[0_50px_100px_-20px_rgba(239,68,68,0.3)] scale-105 z-10" : "bg-white/5 border-white/5 hover:border-white/20"}`}
                  >
                    {idx === 1 && (
                      <span className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 px-6 py-2 rounded-full bg-white text-primary text-[10px] font-black uppercase tracking-[0.3em] shadow-xl">
                        Recommended Solution
                      </span>
                    )}
                    <h4 className="text-sm font-black uppercase tracking-[0.3em] mb-4 opacity-60">
                      {option.name}
                    </h4>
                    <p className="text-6xl font-black mb-10 tracking-[0.05em]">
                      {option.price}
                    </p>
                      ...
                      {option.features.map((f, fi) => (
                        ...
                        >
                          ...
                          <span
                            className={
                              idx === 1
                                ? "text-white opacity-80 leading-relaxed uppercase tracking-tighter"
                                : "text-white/80 leading-relaxed uppercase tracking-tighter"
                            }
                          >
                            {f}
                          </span>
                    ...
                    <Link
                      href={`/contact?subject=${service.title} - ${option.name}`}
                    >
                      <button
                        className={`w-full py-6 rounded-2xl font-black text-xl transition-all shadow-2xl ${idx === 1 ? "bg-white text-primary hover:bg-zinc-100 hover:scale-105" : "bg-primary text-white hover:bg-primary/90 hover:scale-105 shadow-primary/20"}`}
                      >
                        Initialize
                      </button>
                    </Link>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-left mb-20 border-l-4 border-primary pl-8">
              <h2 className="text-5xl font-black tracking-tighter mb-4 italic">
                Expert <span className="not-italic">Intel.</span>
              </h2>
              <p className="text-foreground/40 text-lg font-bold uppercase tracking-[.2em]">
                Operational Q&A
              </p>
            ...
            <div className="grid lg:grid-cols-2 gap-20 items-center">
              <MotionWrapper type="slideLeft">
                ...
                <p className="text-white/50 text-xl font-medium mb-12 max-w-lg leading-relaxed italic">
                  Deployment awaits. Let's translate your vision into
              ...
              <MotionWrapper type="slideRight">
                <div className="p-12 rounded-[4rem] bg-white/5 border border-white/10 backdrop-blur-3xl text-center relative overflow-hidden text-white">
                  ...
                  <p className="text-white/40 font-medium mb-10 text-sm">
                    Typical response within 180 minutes for enterprise
                    inquiries.
                  </p>
                  <Link
                    href="/contact"
                    className="text-primary font-black uppercase tracking-[0.3em] text-[10px] hover:tracking-[0.5em] transition-all flex items-center justify-center gap-2"
                  >
