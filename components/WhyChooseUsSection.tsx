            ...
            <div className="lg:w-2/3">
                <SnapCarousel scrollContainerClassName="sm:grid sm:grid-cols-2 md:grid-cols-2 md:gap-6">
                   <div className="min-w-[75vw] sm:min-w-0 md:col-span-1 h-full bg-white/40 dark:bg-white/5 backdrop-blur-md p-6 md:p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800">
                      ...
                      <h3 className="text-xl font-bold text-foreground mb-2">Global Expertise</h3>
                      <p className="text-foreground/70 text-sm leading-relaxed">Serving clients across 12 countries with international standards and localized support.</p>
                   </div>
                   <div className="min-w-[75vw] sm:min-w-0 md:col-span-1 h-full bg-white/40 dark:bg-white/5 backdrop-blur-md p-6 md:p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800">
                      <Zap className="text-primary mb-4" size={40} />
                      <h3 className="text-xl font-bold text-foreground mb-2">Agile Delivery</h3>
                      <p className="text-foreground/70 text-sm leading-relaxed">Fast-paced development cycles with weekly sprints ensuring timely and transparent project delivery.</p>
                   </div>
                   <div className="min-w-[75vw] sm:min-w-0 md:col-span-1 h-full bg-white/40 dark:bg-white/5 backdrop-blur-md p-6 md:p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800">
                      <DollarSign className="text-primary mb-4" size={40} />
                      <h3 className="text-xl font-bold text-foreground mb-2">Cost-Effective</h3>
                      <p className="text-foreground/70 text-sm leading-relaxed">High-quality software solutions at competitive price points, maximizing your ROI.</p>
                   </div>
                   <div className="min-w-[75vw] sm:min-w-0 md:col-span-1 h-full bg-white/40 dark:bg-black p-6 md:p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800">
                      ...
                      <p className="text-foreground/70 text-sm leading-relaxed">Dedicated technical support across all time zones to ensure your systems never sleep.</p>
                   </div>
                </SnapCarousel>
            </div>
          </div>
