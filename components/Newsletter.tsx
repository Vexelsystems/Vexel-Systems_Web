...
export default function Newsletter({ category = "General", className = "" }: { category?: string, className?: string }) {
  ...
  return (
    <div className={`p-8 bg-primary rounded-[32px] text-white shadow-2xl shadow-primary/20 ${className}`}>
