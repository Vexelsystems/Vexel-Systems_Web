    ...
    <main className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
       ...
       >
          <div className="text-center mb-10">
             <Link href="/" className="inline-block mb-6 relative hover:scale-105 transition-transform">
             ...
             <p className="text-foreground/60 text-sm font-medium">Enter your credentials to access the Vexel Nexus</p>
          </div>
            ...
            <div className="space-y-4">
                ...
                <div className="space-y-2">
                    <div className="flex justify-between items-center ml-1">
                        ...
                        <a href="#" className="text-xs font-bold text-foreground/40 hover:text-primary transition-colors">Forgot?</a>
                    </div>
                    <div className="relative group">
            ...
            >
                {isLoading ? (
                    <>
                        ...
                        <span className="relative z-10 font-bold tracking-widest text-sm">{Math.round(progress)}% Authenticating</span>
                    </>
                ) : (
