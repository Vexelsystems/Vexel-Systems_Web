...
export const GlowingBackground = () => {
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none -z-40 select-none">
      {/* Blue Glow - Top Left */}
      <div className="absolute -top-[10%] -left-[10%] w-[70%] h-[70%] rounded-full bg-primary/5 blur-[160px] dark:hidden" />
      {/* Purple Glow - Bottom Right */}
      <div className="absolute -bottom-[10%] -right-[10%] w-[70%] h-[70%] rounded-full bg-purple-600/5 blur-[160px] dark:hidden" />
    </div>
  );
};
