          ...
          <div className="sticky top-24 space-y-4">
            ...
            <div className="bg-primary/5 rounded-xl p-5 border border-primary/20">
              ...
              <p className="text-xs text-foreground/70 mb-4">
                Our support team is available 24/7 for urgent Vexel inquiries.
              </p>
        ...
        <div className="flex-1 space-y-12">
                ...
                filteredFaqs.map((faq, index) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        className={`p-2 rounded-full transition-all duration-300 ${openIndex === index ? "bg-primary text-white rotate-180" : "bg-black/5 dark:bg-white/5 text-black/50 dark:text-white/50"}`}
                      >
                        <ChevronDown size={20} />
                      </div>
                    </button>
                    ...
                    <div
                      className={`transition-all duration-500 ease-in-out px-8 overflow-hidden ${openIndex === index ? "max-h-[500px] pb-8 opacity-100" : "max-h-0 opacity-0"}`}
                    >
          ...
          {activeCategory === "pricing" && (
            <div className="bg-primary/10 rounded-xl border border-primary/20 p-6 flex flex-col gap-4">
              ...
              <p className="font-bold text-lg">
                All plans are billed monthly by default, but annual plans offer
                a 20% discount.
              </p>
            </div>
          )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-card p-6 rounded-xl border border-primary/10 hover:shadow-lg hover:-translate-y-1 transition-all">
                ...
                <p className="text-sm text-foreground/70 mb-4">
                  Allow our engineers to securely access your system to fix
                  issues in real-time.
                </p>
              ...
              <div className="bg-card p-6 rounded-xl border border-primary/10 hover:shadow-lg hover:-translate-y-1 transition-all">
                ...
                <p className="text-sm text-foreground/70 mb-4">
                  Check for any known outages or scheduled maintenance windows.
                </p>
          ...
          <div className="pt-8 border-t border-primary/10 flex flex-col items-center text-center">
            ...
            <p className="text-foreground/70 mb-8 max-w-lg">
              If you couldn't find what you were looking for, our expert team is
              ready to help you optimize your business operations.
            </p>
